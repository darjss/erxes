...
import { MtoPageLayout } from './MtoPageLayout';

interface MtoListPageLayoutProps<TFilters> {
  pageName: string;
  pageIcon?: ReactNode;
  filters: TFilters;
...
export function MtoListPageLayout<TFilters>({
  pageName,
  pageIcon,
  filters,
  onFiltersChange,
  ...
  headerActions,
}: MtoListPageLayoutProps<TFilters>) {
  return (
    <MtoPageLayout
      pageName={pageName}
      pageIcon={pageIcon}
