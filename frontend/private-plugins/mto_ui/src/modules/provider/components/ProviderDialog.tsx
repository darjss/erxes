...
const ProviderForm = ({
  ...
  const provider = providerData?.mtoProvider;
  const categories = categoriesData?.mtoActivityCategories || [];
                      ...
                      {field.value ? (
                        <div className="relative w-full">
                          <div className="flex justify-center items-center w-full min-h-28 p-4 rounded-md border bg-accent">
                            <MtoUpload.Preview className="object-contain max-w-full max-h-32" />
                          </div>
                          <Button
                            size="sm"
                            variant="outline"
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <MtoUpload.Root
                          ...
                          uploadUrl={uploadurl}
                        >
                          <MtoUpload.Preview className="hidden" />
                          <MtoUpload.Button
                            size="sm"
                            variant="secondary"
                            type="button"
