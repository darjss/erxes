...
import { UploadProvider } from '@/btk/components/upload';
import { UploadButton } from '@/btk/components/UploadCard';

export const NewsDetailDocument = () => {
  return (
    <div className="p-8">
...
export const NewsDocumentSheet = () => {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <Sheet.View>
        ...
        <NewsDetailDocumentForm onClose={() => setOpen(false)} />
      </Sheet.View>
    </Sheet>
  );
};

export const NewsDetailDocumentForm = ({
  onClose,
}: {
  onClose: () => void;
}) => {
