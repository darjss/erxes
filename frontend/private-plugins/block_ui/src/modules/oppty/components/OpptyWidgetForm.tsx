...
import { widgetOpptySchema, TWidgetOppty } from '@/oppty/types/validations';
...
export const OpptyWidgetForm = ({
  defaultValues,
  onSubmit,
  loading,
}: {
  defaultValues?: Partial<TWidgetOppty>;
  onSubmit: (data: TWidgetOppty) => void;
  loading?: boolean;
}) => {
  const { projects } = useProjects(true);

  const form = useForm<TWidgetOppty>({
    resolver: zodResolver(widgetOpptySchema),
    defaultValues: {
      description: '',
      projectId: '',
      status: '',
