...
// Plugin-local copy of erxes-ui's mapper — see ./README-WHY-LOCAL.md.
// MUST stay byte-for-byte equivalent in behavior to
// frontend/libs/erxes-ui/src/modules/charts/chartSpecToEChartsOption.ts and the
// backend mapper (backend/plugins/erxes-agent_api/src/mastra/charts/echartsOption.ts)
// so a chart looks identical in chat, the Preview panel, and generated documents.
