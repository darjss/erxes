...
router.post('/blockCreateProject', async (req, res) => {
...
router.post('/blockUpdateProjectGeneralInfo', async (req, res) => {
  const models = await generateModels();
...
router.post('/blockPublishProject', async (req, res) => {
  const models = await generateModels();
...
router.post('/blockRemoveProject', async (req, res) => {
  const models = await generateModels();
