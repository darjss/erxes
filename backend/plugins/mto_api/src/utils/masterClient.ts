...
import { getMtoMasterUrl } from '~/constants/mode';
...
export class MasterClient {
  ...
  constructor(masterUrl: string) {
    ...
    // Upload endpoint should go through gateway to mto_api plugin
    this.uploadEndpoint = `${this.masterUrl}/pl:mto_api/upload-file`;
  }
