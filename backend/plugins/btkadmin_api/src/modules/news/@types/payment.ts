...
export interface INewsPaymentPlan extends IBtk {
  name?: string;
...
export interface INewsPaymentPlanDocument extends INewsPaymentPlan, Document {
  _id: string;
  createdAt: Date;
  updatedAt: Date;
}

export enum BtkNewsPaymentPlanFrequency {
  CUSTOM = 'CUSTOM',
  ONE_TIME = 'ONE_TIME',
...
export enum BtkNewsPaymentPlanInterestType {
  SIMPLE = 'SIMPLE',
  FLAT = 'FLAT',
  REDUCING = 'REDUCING',
}

export enum BtkNewsPaymentPlanType {
