...
export const zoningMutations = {
  ...
  btkDupplicateBuildingZoning: async (
    _parent: undefined,
...
requireLogin(zoningMutations, 'btkCreateBuildingZoning');
requireLogin(zoningMutations, 'btkUpdateBuildingZoning');
requireLogin(zoningMutations, 'btkDeleteBuildingZoning');
requireLogin(zoningMutations, 'btkDupplicateBuildingZoning');
